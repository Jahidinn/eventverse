        ...
        <div class="col-md-4 mt-0">
              <div class="card profile-card-5 shadow">
                  ...
                  <div class="card-body pt-0">
                      ...
                      <hr>
                      <p class="card-text"><div class="alert alert-info" role="alert"><strong>Rp 200.000</strong></div></p>
                      <hr>
...
<section class="event-terbaru-setion section-bg pt-4 p-0" style="background-color: #1e4356;">
    <div class="container evnt-terbaru pt-0 mt-0 text-white text-center">
        <div class="py-5">
            <h6>Belum punya event di eventconnect.id?</h6> <button class="btn btn-success"><small><strong><i class="fa fa-calendar-plus"></i> BUAT EVENT</strong></small></button>
        </div>
    </div>
</section>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center px-2 py-4">
            ...
            <div class="icon-box">
              ...
              <p class="description ml-4">Eventconnect.id merupakan platform sharing, ticketing dan manajemen event <strong>Baca selengkapnya ...</strong></p>
            </div>

            <div class="icon-box">
              <span class="ml-4"><strong>KENAPA HARUS EVENTCONNECT.ID?</strong></span>
              <p class="description ml-4 mb-0 mt-2 pb-0 "><i class="fa fa-check text-success"></i> Posting/buat event lebih mudah!</p>
              <p class="description ml-4 mb-0 pb-0"><i class="fa fa-check text-success"></i> Manajemen event lebih teratur</p>
              <p class="description ml-4 mb-0 pb-0 pr-0 mr-0"><i class="fa fa-check text-success"></i> Sistem pendaftaran dan ticketing terogranisir</p>
              <p class="description ml-4 mb-0 pb-0"><i class="fa fa-check text-success"></i> Pemayaran lebih mudah dan aman</p>
              <p class="description ml-4 mb-0 pb-0"><i class="fa fa-check text-success"></i> Meminimalisir penipuan event</p>
            </div>
