        ...
        <div class="card mb-3 mx-1 shadow">
            <div class="card-body p-4">
                <div class="legal-document">
                    ...
                    <section id="perubahan-event" class="py-2">
                        <h4>12. Perubahan atau Pembatalan Event</h4>
                        <p>
                    ...
                    <section id="checkin" class="py-2">
                        <h4>13. Check-In dan Verifikasi Kehadiran</h4>
                        <p>
                    ...
                    <section id="dokumentasi-event" class="py-2">
                        <h4>15. Dokumentasi Event</h4>
                        <p>
                        ...
                        <h5>15.1 Penggunaan Dokumentasi</h5>
                        ...
                        <h5>15.2 Persetujuan Peserta</h5>
                    ...
                    <section id="privasi" class="py-2">
                        <h4>16. Data Pribadi dan Privasi</h4>
                        <p>
                    ...
                    <section id="komunikasi-elektronik" class="py-2">
                    ...
                    <section id="hak-kekayaan-intelektual" class="py-2">
                        <h4>22. Hak Kekayaan Intelektual</h4>
                        <p>
                    ...
                    <section id="user-generated-content" class="py-2">
                        <h4>23. User Generated Content</h4>
                        <p>
                        ...
                        <h5>23.1 Tanggung Jawab Konten</h5>
                    ...
                    <section id="batasan-tanggung-jawab" class="py-2">
                    ...
                    <section id="maksimum-ganti-rugi" class="py-2">
                    ...
                    <section id="indemnification" class="py-2">
                    ...
                    <section id="pajak-organizer" class="py-2">
                    ...
                    <section id="pengalihan-bisnis" class="py-2">
                        <h4>32. Pengalihan Bisnis</h4>
                        <p>
                    ...
                    <section id="kepatuhan-hukum" class="py-2">
                        <h4>33. Kepatuhan Hukum</h4>
                        <p>
                    ...
                    <section id="hukum-berlaku" class="py-2">
                        <h4>35. Hukum yang Berlaku dan Penyelesaian Sengketa</h4>
                    <p>
