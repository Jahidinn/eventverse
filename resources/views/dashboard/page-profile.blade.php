    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body px-0">
                <div class="row col-md-8 p-0 pl-3 ">
                    <div class="col-5">Username</div>
                    <div class="col-7"><b>@</b><b>{{ auth()->user()->username }}</b></div>
                </div>
                <div class="row col-md-8 p-0 pl-3 mt-2">
                    <div class="col-5">Rekening</div>
                    <div class="col-7">{{ auth()->user()->no_rekening }}</div>
                </div>
                <div class="row col-md-8 p-0 pl-3 mt-2">
                    <div class="col-5">Bank</div>
                    <div class="col-7">{{ auth()->user()->bank }}</div>
                </div>
                <div class="row col-md-8 p-0 pl-3 mt-2">
