...
class EventController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		$validasi = Validator::make($request->all(), [
			...
			'linkEvent' => 'required|unique:events,slug|alpha_dash',
			'titleEvent' => 'required',
			...
			'linkEvent.alpha_dash' => 'Link event kamu di eventhub ya, bukan external link!',
		...
		if ($validasi->fails()) {
			...
			$data = [
				...
				'description' => preg_replace("/['\"]/", "-", $request->descriptionEvent),
				'terms' => preg_replace("/['\"]/", "-", $request->terms),
