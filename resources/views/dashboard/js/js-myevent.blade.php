<script>
    $(document).ready(function(e) {
        ...
        $('body').on('click', '.detail-myevent', function(e) {
            ...
            window.location = "/transaction/" + transaction_code + "/detail";
        })

        $('body').on('click', '.invoice-myevent', function(e) {
            e.preventDefault();
            var transaction_code = $(this).data('transaction_code');
            // const hashids = new Hashids('eventhub-secret', 25);
            // const hashIdTransaction = hashids.encode(id);
            window.location = "/transaction/" + transaction_code + "/invoice";
        })

        $('body').on('click', '.ticket-myevent', function(e) {
            e.preventDefault();
            var transaction_code = $(this).data('transaction_code');
            window.location = "/transaction/" + transaction_code + "/ticket";
        })

        $('body').on('click', '.lanjutkan-transaksi', function(e) {
            e.preventDefault();
            var transaction_code = $(this).data('transaction_code');
            window.location = "/transaction/" + transaction_code;
        });
