                                            ...
                                            <td align="left">
                                                <table role="presentation" border="0" cellspacing="4" cellpadding="3">
                                                    <tbody>
                                                        <tr>
                                                            @php
                                                                $hashids = new \Hashids\Hashids('eventhub-secret', 25);
                                                            @endphp
                                ...
                                <td class="content-block">
                                    <div style="text-align: center">
                                        <img style="text-align: center; height:50px; margin-bottom: 10px;"
                                            src="{{ $message->embed(public_path() . '/assets/img/eventhub-3.png') }}">
                                    </div>
                                    <span class="apple-link">PT Konektivitas Tanpa Batas</span>
