                    ...
                    <div class="col-md-12 py-4">
                        <div class="container p-0">
                            <div class="col-md-12 row tabs">
                                <div class="col px-0">
                                    <button class="tab-link current w-100 m-0 py-1" type="button"
                                        data-tab="tab-1">Deskripsi</button>
                                </div>
                                <div class="col p-0">
                                    <button class="tab-link w-100 py-1" type="button" data-tab="tab-2">Tiket
                                        Pendaftaran</button>
                                </div>
                            </div>
                            <hr>
                                    ...
                                    <div class="card  ticket-card mt-3" id="ticket-example">
                                        <div class="card-body">
                                            ...
                                            <div class="d-inline">
                                                ...
                                                <div class="float-end">
                                                    <button type="button" class="btn btn-success px-3">DAFTAR
                                                        SEKARANG</button>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name="form-ticket" id="form-ticket">
                                ...
                                <label for="ticketDate" class="form-control-label">DEADLINE TIKET</label>
